      ...
      <form onSubmit={calc} className="space-y-4">
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <select value={form.breed} onChange={(e) => set("breed", e.target.value)} className="w-full px-4 py-2 border rounded-lg">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Idade (semanas)</label>
            <input value={form.age} onChange={(e)=>set("age", e.target.value)} type="number" min="0" className="w-full px-4 py-2 border rounded-lg" placeholder="Ex: 20" />
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Peso médio (kg)</label>
            <input value={form.weight} onChange={(e)=>set("weight", e.target.value)} type="number" step="0.01" min="0" className="w-full px-4 py-2 border rounded-lg" placeholder="Ex: 2.50" />
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Quantidade</label>
            <input value={form.quantity} onChange={(e)=>set("quantity", e.target.value)} type="number" min="1" className="w-full px-4 py-2 border rounded-lg" placeholder="Ex: 50" />
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Saúde</label>
            <select value={form.health} onChange={(e)=>set("health", e.target.value)} className="w-full px-4 py-2 border rounded-lg">
          ...
          <div>
            ...
            <select value={form.environment} onChange={(e)=>set("environment", e.target.value)} className="w-full px-4 py-2 border rounded-lg">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Estação</label>
            <select value={form.season} onChange={(e)=>set("season", e.target.value)} className="w-full px-4 py-2 border rounded-lg">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Luz diária (h)</label>
            <input value={form.lightHours} onChange={(e)=>set("lightHours", +e.target.value)} type="number" min="0" max="24" className="w-full px-4 py-2 border rounded-lg" />
          </div>
        </div>
